...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   all_function_header_6x6.h                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: marvin <marvin@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/29 11:12:44 by schuah            #+#    #+#             */
/*   Updated: 2022/05/29 12:39:16 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_xy(int table[6][6], int pos, int input[36]);
int		*get_input(char *str);
int		solve_puzzle(int table[6][6], int input[36], int pos);
void	print_result(int table[6][6]);
